<%@ Page Title="" Language="C#" MasterPageFile="~/master_Principal.Master" AutoEventWireup="true" CodeBehind="aspEditarProveedor.aspx.cs" Inherits="wsCompras_Hgo.Formulario_web124" %>
    ...
    <script type = "text/javascript">
        function confirm_closing() {
            ...
            if (confirm("¿Eliminar registro?")) {
                confirm_closingValue.value = "Si";
            } else {
                confirm_closingValue.value = "Cancelar";
            }
    ...
    <table style="width: 100%;" id="main">
        ...
        <tr>
            <td colspan="5" style="text-align:center">
                <asp:Button ID="btnAceptar" runat="server" Text="Actualizar" OnClick="btnAceptar_Click" />&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" OnClick="btnEliminar_Click" OnClientClick="confirm_closing()"/>&nbsp;&nbsp;&nbsp;
