<%@ Page Title="" Language="C#" MasterPageFile="~/master_Principal.Master" AutoEventWireup="true" CodeBehind="aspODCRevision.aspx.cs" Inherits="wsCompras_Hgo.Formulario_web127" %>
        ...
        <tr>
            <td>
                <asp:GridView ID="grdODC" runat="server" AllowSorting="True" OnSorting="grdODC_Sorting" CssClass="gv">
                    ...
                    DataNavigateUrlFormatString="aspEditarODC.aspx?id={0}"
                     NavigateUrl="aspEditarODC.aspx?id={0}"/>
                        </columns>
                </asp:GridView>
            </td>
        </tr>
