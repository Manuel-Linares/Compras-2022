...
namespace wsCompras_Hgo
{
    public partial class Formulario_web126 : System.Web.UI.Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    ...
                    {
                        //Inserción exitosa
                        Response.Redirect("aspPartidasPendientes.aspx?msg=1");
        ...
        public void requi()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                lblRequi.Text = dt.Rows[0]["Requisicion"].ToString();
                ...
                lblUDeMedicion.Text = dt.Rows[0]["Medicion"].ToString();
            }
        }
        ...
        {
            Response.Redirect("aspPartidasPendientes.aspx?msg=0");
        }
    }
}