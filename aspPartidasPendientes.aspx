<%@ Page Title="" Language="C#" MasterPageFile="~/master_Principal.Master" AutoEventWireup="true" CodeBehind="aspPartidasPendientes.aspx.cs" Inherits="wsCompras_Hgo.Formulario_web111" %>
         ...
         <tr>
             <td colspan="5">
                 <asp:GridView ID="grdRequi" runat="server" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="grdRequi_PageIndexChanging" OnSorting="grdRequi_Sorting" CssClass="gv" PageSize="30" PagerSettings-Position="TopAndBottom">
                     <columns>
                    <asp:HyperLinkField Text="Actualizar" DataNavigateUrlFields="Folio Requisicion" HeaderText=""
