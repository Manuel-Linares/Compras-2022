...
namespace wsCompras_Hgo.RRMM
{
    public partial class Formulario_web18 : System.Web.UI.Page
    {
        ...
        {
            ds = new DataSet();
            ds = obj.listarRequiRRMM(Application["cnn"].ToString(), int.Parse(Session["plaza"].ToString()));
            return ds.Tables[0];
        }
        ...
        void requisiciones()
        {
            ...
            {
                lblRequis.Visible = true;
                lblRequis.Text = "No hay requisiciones por autorizar";
            }
        }
