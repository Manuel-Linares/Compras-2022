...
do {  
?>
      <option value="<?php echo $row_ODC_AUT1['id']?>"><?php echo $row_ODC_AUT1['id']?></option>
      <?php
} while ($row_ODC_AUT1 = mysql_fetch_assoc($ODC_AUT1));
  $rows = mysql_num_rows($ODC_AUT1);
  if($rows > 0) {
      mysql_data_seek($ODC_AUT1, 0);
	  $row_ODC_AUT1 = mysql_fetch_assoc($ODC_AUT1);
  }
?>
    </select>
  </p>
