...
$ODC = mysqli_query($comprashgo, $query_ODC) or die(mysqli_error());

$row_ODC = mysqli_fetch_assoc($ODC);

$totalRows_ODC = mysqli_num_rows($ODC);
...
$ODCDETA = mysqli_query($comprashgo, $query_ODCDETA) or die(mysqli_error());

$row_ODCDETA = mysqli_fetch_assoc($ODCDETA);

$totalRows_ODCDETA = mysqli_num_rows($ODCDETA);
...
<title>ODC AUTORIZADA CON IMPUESTOS</title>
...
<table width="792" border="1" align="center" bordercolor="#000000">
  ...
  <?php } while ($row_ODCDETA = mysqli_fetch_assoc($ODCDETA)); ?>
...
<table width="792" border="1" align="center" bordercolor="#000000">
  ...
  <tr>
    ...
    <td width="162" rowspan="4" align="center" valign="top"><span class="Estilo29">FECHA, NOMBRE Y FIRMA DE QUIEN RECIBE ORDEN DE COMPRA:</span></td>

    <td width="70" rowspan="3"><div align="center" class="Estilo30"><strong><span class="Estilo3">Plazo de Prueba o Garant&iacute;a</span></strong></div></td>

    <td width="53" rowspan="3"><div align="center" class="Estilo30"><strong><span class="Estilo3">Forma de Pago</span></strong></div></td>

    <td width="55" rowspan="4"><div align="center"><strong><span class="Estilo27">Fianzas</span></strong></div></td>
    ...
    <td width="146" class="Estilo27"><div align="center" class="Estilo22"><strong>$ <?php echo number_format($sub,2); ?> M.N.</strong></div></td>

  </tr>

  <tr>

    <td height="23" rowspan="2"><span class="Estilo26">Cumplimiento:</span></td>

    <td rowspan="2">&nbsp;</td>

    <td class="Estilo27"><div align="right" class="Estilo20"><strong><span class="Estilo20"><?php echo $_GET['tipo']; ?><br>

      </span></strong></div></td>

    <td class="Estilo27"><div align="center" class="Estilo20"><strong><span class="Estilo20">$ <?php echo number_format($_GET['monto'],2); ?> M.N.<br>
  ...
  <tr>
    ...
    <td class="Estilo27"><div align="right"><span class="Estilo20"><strong><span class="Estilo20">IVA /TAX</span></strong></span></div></td>

  <td class="Estilo27"><div align="center"><span class="Estilo20"><strong><span class="Estilo20">$ <?php echo number_format($_GET['iva'],2); ?> M.N.</span></strong></span></div></td>
  ...
  <tr>
	...
	$total = $sub + $_GET['iva']+$_GET['monto'];

	?>

    <td class="Estilo27"><div align="center" class="Estilo20"><strong><span class="Estilo22">$ <?php echo number_format($total,2); ?> M.N.</span></strong></div></td>
...
mysqli_free_result($ODC);



mysqli_free_result($ODCDETA);
