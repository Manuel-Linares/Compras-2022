...
body {
	...
	background-image: url(borrador.jpg);
...
<table width="792" border="0" align="center">
  ...
  <tr>
    ...
    <td colspan="3"><div align="center"><span class="Estilo1">ORDEN DE COMPRA NO AUTORIZADA <br>

        <span class="Estilo2">PURCHASE ORDER<br>
...
<table width="792" border="1" align="center" bordercolor="#000000">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><p align="center" class="Estilo16 Estilo15"><span class="Estilo7"><?php echo $row_ODC['consignara']; ?></span><br>
  ...
  <tr>
    ...
    <td colspan="2"><span class="Estilo7"><?php echo $row_ODC['observaciones']; ?></span><span class="Estilo16"><br>
...
<table width="792" border="1" align="center" bordercolor="#000000">
  ...
  <tr>
   ...
   <?php $orden++;?>
    ...
    <td><div align="center"><span class="Estilo7"><?php echo $orden; ?></span></div></td>
...
<table width="792" border="1" align="center" bordercolor="#000000">
  ...
  <tr>
    ...
    <td class="Estilo27"><div align="center" class="Estilo20"><strong><span class="Estilo3">$ <?php echo round(($sub*.16)*100)/100; ?> M.N.</span></strong></div></td>
  ...
  <tr>
    ...
    <td class="Estilo27"><div align="center" class="Estilo20"><strong><span class="Estilo22">$ <?php echo number_format(round(($sub*1.16)*100)/100,2); ?> M.N.</span></strong></div></td>
