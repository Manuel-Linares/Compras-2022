...
namespace wsCompras_Hgo.Compras
{
    public partial class Formulario_web112 : System.Web.UI.Page
    {
        ...
        {
            ds = new DataSet();
            ds = obj.listarPartidasUrgentes(Application["cnn"].ToString(), int.Parse(Session["plaza"].ToString()));
            return ds.Tables[0];
        }
        ...
        void requisiciones()
        {
            ...
            grdRequi.DataMember = "PARTIDASURGENTES";
            grdRequi.DataBind();
            ...
            {
                lblRequis.Visible = true;
                lblRequis.Text = "No hay partidas urgentes";
            }
        }
