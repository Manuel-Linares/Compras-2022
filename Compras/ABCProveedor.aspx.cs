...
namespace wsCompras_Hgo.Master
{
    public partial class Formulario_web1 : System.Web.UI.Page
    {
        ...
        {
            ds = new DataSet();
            ds = obj.ListarProveedores(Application["cnn"].ToString());
            return ds.Tables[0];
        }
        ...
        void proveedores()
        {
            ...
            grdRequi.DataMember = "proveedores";
            grdRequi.DataBind();
            ...
            if (cont > 0)
            {
                ...
                lblRequis.Text = "No. de Proveedores: " + cont;
            }
            else
            {
                lblRequis.Visible = true;
                lblRequis.Text = "No hay proveedores dados de alta";
            }
        }
