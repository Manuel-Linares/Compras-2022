<%@ Page Title="" Language="C#" MasterPageFile="~/Compras/master_Compras.Master" AutoEventWireup="true" CodeBehind="aspComprasCom.aspx.cs" Inherits="wsCompras_Hgo.Compras.Formulario_web18" %>
         ...
         <tr>
             <td colspan="5">
                 <asp:GridView ID="grdRequi" runat="server" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="grdRequi_PageIndexChanging" OnSorting="grdRequi_Sorting" CssClass="gv" PageSize="30" PagerSettings-Position="TopAndBottom">
                    ...
                    DataNavigateUrlFormatString="aspEditarCompras.aspx?folio={0}"
                     NavigateUrl="aspEditarCompras.aspx?folio={0}"/>
                        </columns>
