<%@ Page Title="" Language="C#" MasterPageFile="../Master/master_DG.Master" AutoEventWireup="true" CodeBehind="aspEditarRequiDG.aspx.cs" Inherits="wsCompras_Hgo.DG.Formulario_web19" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width:100%;" id="main">
        <tr>
            <th colspan="5" style="text-align:left;"><h1>Dirección General: Autorizar</h1></th>
        </tr>
        <tr>
