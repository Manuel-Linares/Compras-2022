...
namespace wsCompras_Hgo.DG
{
    public partial class Formulario_web19 : System.Web.UI.Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    ...
                    {
                        // Inserción exitosa
                        Response.Redirect("aspInicioDG.aspx?msg=2");
                    }
                    else
                    {
                        // Error
        ...
        public void LlenarStatus()
        {
            ...
            ds = new DataSet();
            ds = obj.ConsultaEstatus(Application["cnn"].ToString(), 1); // Ejecutara el metodo que muestra a todos los tipos de empleados
        ...
        {
            Response.Redirect("aspRequiDG.aspx");
        }
    }
}